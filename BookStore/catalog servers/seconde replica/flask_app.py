...
def readDistributedSystemsFile(): #read DOS files
    ...
    f = open("/home/bara1111/FlaskApp/distributed_systems.txt", "r")
    m = open("/home/bara1111/FlaskApp/quantity_distributed_systems.txt", "r")
    t = open("/home/bara1111/FlaskApp/id_distributed_systems.txt", "r")
...
def readGraduateSchoolFile(): #read graduateSchool files
    ...
    f = open("/home/bara1111/FlaskApp/graduate_school.txt", "r")
    m = open("/home/bara1111/FlaskApp/quantity_graduate_school_systems.txt", "r")
    t = open("/home/bara1111/FlaskApp/id_graduate_school.txt", "r")
...
def id():
    ...
    idsForGraduateSchool=[]
    dataForGraduateSchool['book'] = []
    q = open("/home/bara1111/FlaskApp/graduate_school.txt", "r")
    w = open("/home/bara1111/FlaskApp/quantity_graduate_school_systems.txt", "r")
    e = open("/home/bara1111/FlaskApp/id_graduate_school.txt", "r")
...
def buyGraduateSchoolId():
    ...
    if (index != -1):
                ...
                if(dataFormatedInt!=0):
                          ...
                          f = open('/home/bara1111/FlaskApp/quantity_graduate_school_systems.txt', 'w')
                          for i in range(len(namesForGraduateSchool)):
                               f.write(quantitysGraduateSchool[i])
                          f.close()
                          return redirect("http://bara111.pythonanywhere.com/update/graduateSchool/id?id="+str(id)) #call request while buying is success to update other servers
                else:
                    return '{ "status":"fail"}'
...
def buyDOSId():
    ...
    if (index != -1):
                ...
                if(dataFormatedInt!=0):
                          ...
                          f = open('/home/bara1111/FlaskApp/quantity_distributed_systems.txt', 'w')
                          for i in range(len(namesForDosBooks)):
                              f.write(quantitysDOS[i])
                          f.close()
                          return redirect("http://bara111.pythonanywhere.com/update/dos/id?id="+str(id)) #call request while buying is success to update other servers
                else:
                    return '{ "status":"fail"}'

@app.route('/update/dos/id',methods=['GET']) #handle update of DOS catagory when buying from other servers
def updateDOSId():
    dataForDosBooks = {}
    namesForDosBooks=[]
    quantitysForDosBooks=[]
